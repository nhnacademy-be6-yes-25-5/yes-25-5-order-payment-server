...
@Builder
public record ReadOrderDeliveryResponse(String orderId, Long customerId, BigDecimal orderTotalAmount,
    ...
    public static ReadOrderDeliveryResponse of(Order order, List<ReadBookResponse> responses,
        ...
        return ReadOrderDeliveryResponse.builder()
